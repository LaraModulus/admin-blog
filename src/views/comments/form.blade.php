                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="author_names" id="author_names" value="{{old('author_names', $comment->author_names)}}">
                            </div>
                            <div class="form-group">
                                <label for="author_url">Author url</label>
                                <input type="text" class="form-control" name="author_url" id="author_url" value="{{old('author_url', $comment->author_url)}}">
                            </div>
                            <div class="form-group">
