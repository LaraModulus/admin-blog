                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title_{{$locale}}" id="title_{{$locale}}"
                                       placeholder="" value="{{old('title_'.$locale, $category->{'title_'.$locale})}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="meta_title_{{$locale}}" id="meta_title_{{$locale}}"
                                       placeholder="" value="{{old('meta_title_'.$locale, $category->{'meta_title_'.$locale})}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="meta_keywords_{{$locale}}" id="meta_keywords_{{$locale}}"
                                       placeholder="" value="{{old('meta_keywords_'.$locale, $category->{'meta_keywords_'.$locale})}}">
            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                	<div class="panel-body">
                        ...
                        @if(\LaraMod\AdminBlog\Models\Categories::where('id', '!=', $category->id)->count())
                        <div class="form-group">
                            ...
                            <select class="form-control selector" name="categories_id" id="categories_id">
                                ...
                                @foreach(\LaraMod\AdminBlog\Models\Categories::where('id', '!=', $category->id)->get() as $c)
